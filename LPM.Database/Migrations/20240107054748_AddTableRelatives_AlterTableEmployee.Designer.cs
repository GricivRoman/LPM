...
namespace LPM.Database.Migrations
{
    ...
    [Migration("20240107054748_AddTableRelatives_AlterTableEmployee")]
    partial class AddTableRelatives_AlterTableEmployee
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeRelative", b =>
                {
                    ...
                    b.HasKey("EmployeeId", "RelativeId");
            ...
            modelBuilder.Entity("LPM.Database.Models.Relative", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("IsCripple")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsPreSchoolkid")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsSchoolkid")
                        .HasColumnType("boolean");

                    b.Property<string>("Name")
                        .HasColumnType("text");

                    b.Property<string>("RelativeKind")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("EmployeeRelative", b =>
                {
                    b.HasOne("LPM.Database.Models.Employee", null)
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LPM.Database.Models.Relative", null)
                        .WithMany()
